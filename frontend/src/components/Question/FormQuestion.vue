        ...
        <form @submit.prevent="handleSubmit">
            <AlertMessage v-if="errorAlert" :message="errorMsg"/>
             <div class="flex align-items-center gap-3 mb-3">
                 <InputText id="title" v-model="question.title" class="flex-auto" autocomplete="off" placeholder="Insert Ypur Question"/>
                </div>
                <div class="flex align-items-center gap-3 mb-5">
                    <Editor editorStyle="height :320px" v-model="question.question" style="width: 100%;" placeholder="Insert Ypur Question"></Editor>
                </div>
                <div class="flex align-items-center gap-3 mb-5">
